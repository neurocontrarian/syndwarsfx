...
enum GameKeys
{
  ...
  GKey_DANGR_TRACK = 31,
  GKey_MUSIC_TRACK = 32,
  GKey_SOUND_VOL_INC = 33,
  GKey_SOUND_VOL_DEC = 34,
  GKey_DANGR_VOL_INC = 35,
  GKey_DANGR_VOL_DEC = 36,
  GKey_MUSIC_VOL_INC = 37,
  GKey_MUSIC_VOL_DEC = 38,
  GKey_MISSN_RESTART = 39,
  GKey_GAMESPEED_INC = 40,
  GKey_GAMESPEED_DEC = 41,
  GKey_SCREENSHOT = 42,
  GKey_SEL_WEP_1 = 43,
  GKey_SEL_WEP_2 = 44,
  GKey_SEL_WEP_3 = 45,
